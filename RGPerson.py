...
def genMobile():
    prelist = {"133": "电信", "149": "电信", "153": "电信", "173": "电信", "177": "电信", "180": "电信", "181": "电信", "189": "电信", "199": "电信", "130": "联通", "131": "联通", "132": "联通", "145": "联通", "155": "联通", "156": "联通", "166": "联通", "171": "联通", "175": "联通", "176": "联通", "185": "联通", "186": "联通",
...
def genIdCard(age, gender):
    ...
    if str(area_code) not in area_dict.keys():
        return None
    datestring = str(date(date.today().year - age, 1, 1) +
                     timedelta(days=random.randint(0, 364))).replace("-", "")
    ...
    b = result + \
        str(check_code_list[sum(
            [a * b for a, b in zip(id_code_list, [int(a) for a in result])]) % 11])
    return b
...
def genCreditCode():
    orgCode = {"1": "机构编制", "2": "外交", "3": "教育", "4": "公安", "5": "民政", "6": "司法",
               "7": "交通运输", "8": "文化", "9": "工商", "A": "中央军委改革和编制办公室", "N": "农业", "Y": "其他"}

    icCode = {"1": {"1": "机关", "2": "事业单位", "3": "中央编办直接管理机构编制的群众团体", "9": "其他"}, "2": {"1": "外国常驻新闻机构", "9": "其他"}, "3": {"1": "律师执业机构", "2": "公证处", "3": "基层法律服务所", "4": "司法鉴定机构", "5": "仲裁委员会", "9": "其他"}, "4": {"1": "外国在华文化中心", "9": "其他"}, "5": {"1": "社会团体", "2": "民办非企业单位", "3": "基金会", "9": "其他"}, "6": {
        "1": "外国旅游部门常驻机构代表机构", "2": "港澳台地区旅游部门常驻内地（大陆）代表机构", "9": "其他"}, "7": {"1": "宗教活动场所", "2": "宗教院校", "9": "其他"}, "8": {"1": "基层工会", "9": "其他"}, "9": {"1": "企业", "2": "个体工商户", "3": "农民专业社"}, "A": {"1": "军队事业单位", "9": "其他"}, "N": {"1": "组级集体经济组织", "2": "村级集体经济组织", "3": "乡镇集体经济组织", "9": "其他"}, "Y": {"1": "其他"}}
    ...
    orgtype = list(icCode[regOrg].keys())[
        random.randint(0, len(icCode[regOrg].keys())-1)]
...
if __name__ == '__main__':
    ...
    print("ID: {}\n姓名: {} 拼音: {} \n年龄: {}\n性别: {}\n身份证: {}\n手机号: {} {}\n组织机构代码: {}\n统一社会信用代码: {}\n单位性质: {}".format(genHackerId(), name, ''.join(lazy_pinyin(name)), age, sex,
                                                                                                                   genIdCard(age, gender), list(genMobile().keys())[0], list(genMobile().values())[0], genOrgCode(), list(genCreditCode().keys())[0], list(genCreditCode().values())[0]))
